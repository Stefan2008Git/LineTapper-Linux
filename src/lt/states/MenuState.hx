...
class MenuState extends State {
	...
	override function create() {
		...
		FlxTimer.wait(2, ()->{
			Dialog.show(PhraseManager.getPhrase("greet_title", "Hey there!"), PhraseManager.getPhrase("greet_body", "Welcome to LineTapper! This game is still in development and most of it are not final, so expect bugs and errors at some point of this game. Though if you ever encountered in one, don't hesitate to report them to LineTapper GitHub Repository!"));
		});
